...
let Autocomplete = React.createClass({
  ...
  maybeScrollItemIntoView () {
    if (this.getFilteredItems().length && this.state.isOpen === true && this.state.highlightedIndex !== null) {
  ...
  render () {
    ...
    return (
      <div style={{...this.props.wrapperStyle}} {...this.props.wrapperProps}>
        ...
        />
        {('open' in this.props ? this.props.open : (this.state.isOpen && this.getFilteredItems().length)) ? this.renderMenu() : ''}
        {this.props.debug && (
