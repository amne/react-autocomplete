...
>>>>>>> 4ec21952a9aed38b07bfd3321300c2d781c981ef
...
describe('Autocomplete blur event handlers', () => {

  const onBlurSpy = chai.spy();
  ...
  it('should call onBlur supplied from props', () => {
    autocompleteInputWrapper.simulate('blur');
...
describe('Autocomplete focus event handlers', () => {

  const onFocusSpy = chai.spy();
  ...
  it('should call onFocus supplied from props', () => {
    autocompleteInputWrapper.simulate('focus');
